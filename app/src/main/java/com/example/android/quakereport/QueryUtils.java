...
public final class QueryUtils {
     ...
     */
    public static ArrayList<Earthquake> extractEarthquakes(String requstedUrl) {
        // If the JSON string is empty or null, then return early.
        if (TextUtils.isEmpty(requstedUrl))
            return null;
        ...
        try {
            JSONObject jsonObject = new JSONObject(requstedUrl);
